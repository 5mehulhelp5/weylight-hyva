...
return [
    'modules' => [
        ...
        'Amasty_ElasticSearchSubscriptionPackagePro' => 1,
        'Amasty_ExtendedProductGridSubscriptionPackage' => 1,
        'Amasty_ProductAttachment' => 1,
        'Amasty_Pgrid' => 1,
        'Amasty_ProductAttachmentLite' => 1,
        'Amasty_ProductAttachmentsSubscriptionPackage' => 1,
        'Amasty_ProductTabsSubscriptionPackage' => 1,
        ...
        'Amasty_XsearchHyvaCompatibility' => 1,
        'Apexia_HyvaCmsStyles' => 1,
        'Bss_AdvancedHidePrice' => 1,
        'Bss_AdvancedHidePriceGraphQl' => 1,
        'Bss_SeoCore' => 1,
        'Bss_CanonicalTag' => 1,
        'Bss_ChatGPT' => 1,
        ...
        'Bss_MetaTagManager' => 1,
        'Bss_ProductLabel' => 1,
        'Bss_ProductLabelGraphQl' => 1,
        'Bss_Breadcrumbs' => 1,
        'Bss_RichSnippets' => 1,
        'Bss_RobotsMetaTag' => 1,
        'Bss_SeoAltText' => 1,
        'Bss_Redirects301Seo' => 1,
        'Bss_SeoExternalLinks' => 1,
        'Bss_SeoReport' => 1,
        'Bss_SeoToolbar' => 1,
        'Bss_UrlRewriteImportExport' => 1,
        'Bss_XmlSiteMap' => 1,
        'Firebear_ImportExport' => 1,
        'Firebear_ImportExportMsi' => 1,
        'Hyva_AmastyStockstatus' => 1,
        'Hyva_BssAdvancedHidePrice' => 1,
        'Hyva_BssBreadcrumbs' => 1,
        'Hyva_BssConvertImageWebp' => 1,
        'Hyva_BssGallery' => 1,
        'Hyva_BssHtmlSiteMap' => 1,
        'Hyva_BssProductLabel' => 1,
        'Hyva_BssRichSnippets' => 1,
        'Hyva_BssSeoToolbar' => 1,
        'Hyva_CmsTailwindJit' => 1,
        'Amasty_CustomTabsHyva' => 1,
        'Hyva_Email' => 1,
        ...
        'Hyva_PaymentIcons' => 1,
        'Amasty_ElasticSearchHyvaCompatibility' => 1,
        'Hyva_Widgets' => 1,
        'Hyva_MagezonBuilder' => 1,
        'Magezon_Newsletter' => 1,
        'Magezon_PageBuilder' => 1,
        'Hyva_MagezonNinjaMenus' => 1,
        ...
        'Mirasvit_BackendSearch' => 1,
        'Hyva_MirasvitBlogMx' => 1,
        'Mirasvit_Brand' => 1,
        'Hyva_MirasvitComment' => 1,
